...
/**
 * Loads cosmetics catalog entries from config/ayanamicosmetics/catalog/
...
public final class CatalogManager {
    ...
    public static File getModConfigDir() {
        return new File(net.minecraft.client.Minecraft.getMinecraft().mcDataDir, "config/ayanamicosmetics");
    }
    ...
    public static void initFolders() {
        ...
        if (!override.exists()) {
            ...
            try {
                ...
                w.write("{\"pack\":{\"pack_format\":3,\"description\":\"AyanamiCosmetics local overrides\"}}");
                w.close();
    ...
    private static void ensureExampleEntry() {
        ...
        try {
            ...
            AyanamiCosmetics.LOGGER.warn("[AyanamiCosmetics] Could not create example catalog entry: {}", e.toString());
        }
    }
    ...
    public static synchronized void reload() {
        ...
        AyanamiCosmetics.LOGGER.info("[AyanamiCosmetics] Catalog loaded: {} entries", ENTRIES.size());
    }
    ...
    private static CatalogEntry readEntry(File folder, File metaFile) {
        ...
        try {
            ...
            AyanamiCosmetics.LOGGER.warn("[AyanamiCosmetics] Bad catalog meta in {}: {}", folder.getName(), e.toString());
            return null;
        } finally {
            if (reader != null) {
                try {
